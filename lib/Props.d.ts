...
export declare namespace NativeWinUI {
    type NativeBreadcrumbBarItemClickedEventArgs = {
        readonly index: number;
        readonly item: object;
    };
}
export declare namespace NativeWinUI {
    type NativeColorChangedEventArgs = {
        readonly newColor: Color | number;
        readonly oldColor: Color | number;
    };
}
export declare namespace NativeWinUI {
    type NativeExpanderCollapsedEventArgs = {};
}
export declare namespace NativeWinUI {
    type NativeExpanderExpandingEventArgs = {};
}
export declare namespace NativeWinUI {
    type NativeInfoBarClosedEventArgs = {
        readonly reason: Enums.WinUIEnums.InfoBarCloseReason;
    };
}
export declare namespace NativeWinUI {
    type NativeInfoBarClosingEventArgs = {
        readonly cancel: boolean;
        readonly reason: Enums.WinUIEnums.InfoBarCloseReason;
    };
}
export declare namespace NativeWinUI {
    type NativeItemsRepeaterElementClearingEventArgs = {};
}
export declare namespace NativeWinUI {
    type NativeItemsRepeaterElementIndexChangedEventArgs = {
        readonly newIndex: number;
        readonly oldIndex: number;
    };
}
export declare namespace NativeWinUI {
    type NativeItemsRepeaterElementPreparedEventArgs = {
        readonly index: number;
    };
}
export declare namespace NativeWinUI {
    type NativeNavigationViewDisplayModeChangedEventArgs = {
        readonly displayMode: Enums.WinUIEnums.NavigationViewDisplayMode;
    };
}
export declare namespace NativeWinUI {
    type NativeNavigationViewItemInvokedEventArgs = {
        readonly invokedItem: object;
        readonly isSettingsInvoked: boolean;
    };
}
export declare namespace NativeWinUI {
    type NativeNavigationViewSelectionChangedEventArgs = {
        readonly isSettingsSelected: boolean;
        readonly selectedItem: object;
    };
}
export declare namespace NativeWinUI {
    type NativeNavigationViewBackRequestedEventArgs = {};
}
export declare namespace NativeWinUI {
    type NativeNavigationViewItemCollapsedEventArgs = {
        readonly collapsedItem: object;
    };
}
export declare namespace NativeWinUI {
    type NativeNavigationViewItemExpandingEventArgs = {
        readonly expandingItem: object;
    };
}
export declare namespace NativeWinUI {
    type NativeNavigationViewPaneClosingEventArgs = {
        readonly cancel: boolean;
    };
}
export declare namespace NativeWinUI {
    type NativeNumberBoxValueChangedEventArgs = {
        readonly newValue: number;
        readonly oldValue: number;
    };
}
export declare namespace NativeWinUI {
    type NativePipsPagerSelectedIndexChangedEventArgs = {};
}
export type NativeSelectionChangedEventArgs = {};
export declare namespace NativeWinUI {
    type NativeRefreshRequestedEventArgs = {};
}
export declare namespace NativeWinUI {
    type NativeRefreshStateChangedEventArgs = {
        readonly newState: Enums.WinUIEnums.RefreshVisualizerState;
        readonly oldState: Enums.WinUIEnums.RefreshVisualizerState;
    };
}
export declare namespace NativeWinUI {
    type NativeSplitButtonClickEventArgs = {};
}
export declare namespace NativeWinUI {
    type NativeTabViewTabCloseRequestedEventArgs = {
        readonly item: object;
    };
}
export declare namespace NativeWinUI {
    type NativeTabViewTabDragCompletedEventArgs = {
        readonly dropResult: Enums.DataPackageOperation;
        readonly item: object;
    };
}
export declare namespace NativeWinUI {
    type NativeTabViewTabDragStartingEventArgs = {
        readonly cancel: boolean;
        readonly item: object;
    };
}
export declare namespace NativeWinUI {
    type NativeTabViewTabDroppedOutsideEventArgs = {
        readonly item: object;
    };
}
...
export declare namespace NativeWinUI {
    type NativeTeachingTipClosedEventArgs = {
        readonly reason: Enums.WinUIEnums.TeachingTipCloseReason;
    };
}
export declare namespace NativeWinUI {
    type NativeTeachingTipClosingEventArgs = {
        readonly cancel: boolean;
        readonly reason: Enums.WinUIEnums.TeachingTipCloseReason;
    };
}
export declare namespace NativeWinUI {
    type NativeToggleSplitButtonIsCheckedChangedEventArgs = {};
}
export declare namespace NativeWinUI {
    type NativeTreeViewCollapsedEventArgs = {
        readonly item: object;
    };
}
export declare namespace NativeWinUI {
    type NativeTreeViewExpandingEventArgs = {
        readonly item: object;
    };
}
export declare namespace NativeWinUI {
    type NativeTreeViewItemInvokedEventArgs = {
        readonly handled: boolean;
        readonly invokedItem: object;
    };
}
export declare namespace NativeWinUI {
    type NativeTreeViewDragItemsCompletedEventArgs = {
        readonly dropResult: Enums.DataPackageOperation;
        readonly newParentItem: object;
    };
}
export declare namespace NativeWinUI {
    type NativeTreeViewDragItemsStartingEventArgs = {
        readonly cancel: boolean;
    };
}
export declare namespace NativeWebView2 {
    type NativeCoreWebView2ProcessFailedEventArgs = {};
}
export declare namespace NativeWinUI {
    type NativeCoreWebView2InitializedEventArgs = {};
}
export declare namespace NativeWebView2 {
    type NativeCoreWebView2NavigationCompletedEventArgs = {};
}
export declare namespace NativeWebView2 {
    type NativeCoreWebView2NavigationStartingEventArgs = {};
}
export declare namespace NativeWebView2 {
    type NativeCoreWebView2WebMessageReceivedEventArgs = {};
}
...
export declare namespace NativeWinUI {
    interface NativeAnimatedIconProps extends NativeIconElementProps {
        type: 'Microsoft.UI.Xaml.Controls.AnimatedIcon';
        mirroredWhenRightToLeft?: boolean;
    }
}
export declare namespace NativeWinUI {
    interface NativeAnimatedVisualPlayerProps extends NativeFrameworkElementProps {
...
export declare namespace NativeWinUI {
    interface NativeBreadcrumbBarProps extends NativeControlProps {
...
export declare namespace NativeWinUI {
    interface NativeBreadcrumbBarItemProps extends NativeContentControlProps {
        type: 'Microsoft.UI.Xaml.Controls.BreadcrumbBarItem';
    }
}
export declare namespace NativeWinUI {
    interface NativeColorPickerProps extends NativeControlProps {
...
export declare namespace NativeWinUI {
    interface NativeCommandBarFlyoutProps extends NativeFlyoutBaseProps {
        type: 'Microsoft.UI.Xaml.Controls.CommandBarFlyout' | 'Microsoft.UI.Xaml.Controls.TextCommandBarFlyout';
    }
}
export declare namespace NativeWinUI {
    interface NativeDropDownButtonProps extends NativeButtonProps {
        type: 'Microsoft.UI.Xaml.Controls.DropDownButton';
    }
}
export declare namespace NativeWinUI {
    interface NativeExpanderProps extends NativeContentControlProps {
...
export declare namespace NativeWinUI {
    interface NativeImageIconProps extends NativeIconElementProps {
        type: 'Microsoft.UI.Xaml.Controls.ImageIcon';
        source?: string;
    }
}
export declare namespace NativeWinUI {
    interface NativeInfoBadgeProps extends NativeControlProps {
        type: 'Microsoft.UI.Xaml.Controls.InfoBadge';
        value?: number;
    }
}
export declare namespace NativeWinUI {
    interface NativeInfoBarProps extends NativeControlProps {
...
export declare namespace NativeWinUI {
    interface NativeItemsRepeaterProps extends NativeFrameworkElementProps {
...
export declare namespace NativeWinUI {
    interface NativeItemsRepeaterScrollHostProps extends NativeFrameworkElementProps {
        type: 'Microsoft.UI.Xaml.Controls.ItemsRepeaterScrollHost';
    }
}
export declare namespace NativeWinUI {
    interface NativeMenuBarProps extends NativeControlProps {
        type: 'Microsoft.UI.Xaml.Controls.MenuBar';
    }
}
export declare namespace NativeWinUI {
    interface NativeMenuBarItemProps extends NativeControlProps {
        type: 'Microsoft.UI.Xaml.Controls.MenuBarItem';
        title?: string;
    }
}
export declare namespace NativeWinUI {
    interface NativeMenuBarItemFlyoutProps extends NativeMenuFlyoutProps {
        type: 'Microsoft.UI.Xaml.Controls.MenuBarItemFlyout';
    }
}
export declare namespace NativeWinUI {
    interface NativeNavigationViewProps extends NativeContentControlProps {
...
export declare namespace NativeWinUI {
    interface NativeNavigationViewItemBaseProps extends NativeContentControlProps {
...
export declare namespace NativeWinUI {
    interface NativeNavigationViewItemProps extends NativeWinUI.NativeNavigationViewItemBaseProps {
...
export declare namespace NativeWinUI {
    interface NativeNavigationViewItemHeaderProps extends NativeWinUI.NativeNavigationViewItemBaseProps {
        type: 'Microsoft.UI.Xaml.Controls.NavigationViewItemHeader';
    }
}
export declare namespace NativeWinUI {
    interface NativeNavigationViewItemSeparatorProps extends NativeWinUI.NativeNavigationViewItemBaseProps {
        type: 'Microsoft.UI.Xaml.Controls.NavigationViewItemSeparator';
    }
}
export declare namespace NativeWinUI {
    interface NativeNumberBoxProps extends NativeControlProps {
...
export declare namespace NativeWinUI {
    interface NativeParallaxViewProps extends NativeFrameworkElementProps {
...
export declare namespace NativeWinUI {
    interface NativePersonPictureProps extends NativeControlProps {
...
export declare namespace NativeWinUI {
    interface NativePipsPagerProps extends NativeControlProps {
...
export declare namespace NativeWinUI {
    interface NativeColorPickerSliderProps extends NativeSliderProps {
        type: 'Microsoft.UI.Xaml.Controls.Primitives.ColorPickerSlider';
        colorChannel?: Enums.WinUIEnums.ColorPickerHsvChannel;
    }
}
export declare namespace NativeWinUI {
    interface NativeColorSpectrumProps extends NativeControlProps {
...
export declare namespace NativeWinUI {
    interface NativeCommandBarFlyoutCommandBarProps extends NativeCommandBarProps {
        type: 'Microsoft.UI.Xaml.Controls.Primitives.CommandBarFlyoutCommandBar';
    }
}
export declare namespace NativeWinUI {
    interface NativeInfoBarPanelProps extends NativePanelProps {
...
export declare namespace NativeWinUI {
    interface NativeMonochromaticOverlayPresenterProps extends NativeGridProps {
        type: 'Microsoft.UI.Xaml.Controls.Primitives.MonochromaticOverlayPresenter';
        replacementColor?: Color | number;
    }
}
export declare namespace NativeWinUI {
    interface NativeNavigationViewItemPresenterProps extends NativeContentControlProps {
        type: 'Microsoft.UI.Xaml.Controls.Primitives.NavigationViewItemPresenter';
    }
}
export declare namespace NativeWinUI {
    interface NativeTabViewListViewProps extends NativeListViewProps {
        type: 'Microsoft.UI.Xaml.Controls.Primitives.TabViewListView';
    }
}
export declare namespace NativeWinUI {
    interface NativeProgressBarProps extends NativeRangeBaseProps {
...
export declare namespace NativeWinUI {
    interface NativeProgressRingProps extends NativeControlProps {
...
export declare namespace NativeWinUI {
    interface NativeRadioButtonsProps extends NativeControlProps {
...
export declare namespace NativeWinUI {
    interface NativeRadioMenuFlyoutItemProps extends NativeMenuFlyoutItemProps {
...
export declare namespace NativeWinUI {
    interface NativeRatingControlProps extends NativeControlProps {
...
export declare namespace NativeWinUI {
    interface NativeRefreshContainerProps extends NativeContentControlProps {
...
export declare namespace NativeWinUI {
    interface NativeRefreshVisualizerProps extends NativeControlProps {
...
export declare namespace NativeWinUI {
    interface NativeRevealListViewItemPresenterProps extends NativeListViewItemPresenterProps {
        type: 'Microsoft.UI.Xaml.Controls.RevealListViewItemPresenter';
    }
}
export declare namespace NativeWinUI {
    interface NativeSplitButtonProps extends NativeContentControlProps {
...
export declare namespace NativeWinUI {
    interface NativeSwipeControlProps extends NativeContentControlProps {
        type: 'Microsoft.UI.Xaml.Controls.SwipeControl';
    }
}
export declare namespace NativeWinUI {
    interface NativeTabViewProps extends NativeControlProps {
...
export declare namespace NativeWinUI {
    interface NativeTabViewItemProps extends NativeListViewItemProps {
...
export declare namespace NativeWinUI {
    interface NativeTeachingTipProps extends NativeContentControlProps {
...
export declare namespace NativeWinUI {
    interface NativeTextCommandBarFlyoutProps extends NativeWinUI.NativeCommandBarFlyoutProps {
        type: 'Microsoft.UI.Xaml.Controls.TextCommandBarFlyout';
    }
}
export declare namespace NativeWinUI {
    interface NativeToggleSplitButtonProps extends NativeWinUI.NativeSplitButtonProps {
...
export declare namespace NativeWinUI {
    interface NativeTreeViewProps extends NativeControlProps {
...
export declare namespace NativeWinUI {
    interface NativeTreeViewItemProps extends NativeListViewItemProps {
...
export declare namespace NativeWinUI {
    interface NativeTreeViewListProps extends NativeListViewProps {
        type: 'Microsoft.UI.Xaml.Controls.TreeViewList';
    }
}
export declare namespace NativeWinUI {
    interface NativeTwoPaneViewProps extends NativeControlProps {
...
export declare namespace NativeWinUI {
    interface NativeWebView2Props extends NativeControlProps {
...
export interface NativeUIElementProps extends NativeDependencyObjectProps {
    type: 'Windows.UI.Xaml.UIElement' | 'Microsoft.UI.Xaml.Controls.AnimatedIcon' | 'Microsoft.UI.Xaml.Controls.AnimatedVisualPlayer' | 'Microsoft.UI.Xaml.Controls.BreadcrumbBar' | 'Microsoft.UI.Xaml.Controls.BreadcrumbBarItem' | 'Microsoft.UI.Xaml.Controls.ColorPicker' | 'Microsoft.UI.Xaml.Controls.DropDownButton' | 'Microsoft.UI.Xaml.Controls.Expander' | 'Microsoft.UI.Xaml.Controls.ImageIcon' | 'Microsoft.UI.Xaml.Controls.InfoBadge' | 'Microsoft.UI.Xaml.Controls.InfoBar' | 'Microsoft.UI.Xaml.Controls.ItemsRepeater' | 'Microsoft.UI.Xaml.Controls.ItemsRepeaterScrollHost' | 'Microsoft.UI.Xaml.Controls.MenuBar' | 'Microsoft.UI.Xaml.Controls.MenuBarItem' | 'Microsoft.UI.Xaml.Controls.NavigationView' | 'Microsoft.UI.Xaml.Controls.NavigationViewItemBase' | 'Microsoft.UI.Xaml.Controls.NavigationViewItem' | 'Microsoft.UI.Xaml.Controls.NavigationViewItemHeader' | 'Microsoft.UI.Xaml.Controls.NavigationViewItemSeparator' | 'Microsoft.UI.Xaml.Controls.NumberBox' | 'Microsoft.UI.Xaml.Controls.ParallaxView' | 'Microsoft.UI.Xaml.Controls.PersonPicture' | 'Microsoft.UI.Xaml.Controls.PipsPager' | 'Microsoft.UI.Xaml.Controls.Primitives.ColorPickerSlider' | 'Microsoft.UI.Xaml.Controls.Primitives.ColorSpectrum' | 'Microsoft.UI.Xaml.Controls.Primitives.CommandBarFlyoutCommandBar' | 'Microsoft.UI.Xaml.Controls.Primitives.InfoBarPanel' | 'Microsoft.UI.Xaml.Controls.Primitives.MonochromaticOverlayPresenter' | 'Microsoft.UI.Xaml.Controls.Primitives.NavigationViewItemPresenter' | 'Microsoft.UI.Xaml.Controls.Primitives.TabViewListView' | 'Microsoft.UI.Xaml.Controls.ProgressBar' | 'Microsoft.UI.Xaml.Controls.ProgressRing' | 'Microsoft.UI.Xaml.Controls.RadioButtons' | 'Microsoft.UI.Xaml.Controls.RadioMenuFlyoutItem' | 'Microsoft.UI.Xaml.Controls.RatingControl' | 'Microsoft.UI.Xaml.Controls.RefreshContainer' | 'Microsoft.UI.Xaml.Controls.RefreshVisualizer' | 'Microsoft.UI.Xaml.Controls.RevealListViewItemPresenter' | 'Microsoft.UI.Xaml.Controls.SplitButton' | 'Microsoft.UI.Xaml.Controls.SwipeControl' | 'Microsoft.UI.Xaml.Controls.TabView' | 'Microsoft.UI.Xaml.Controls.TabViewItem' | 'Microsoft.UI.Xaml.Controls.TeachingTip' | 'Microsoft.UI.Xaml.Controls.ToggleSplitButton' | 'Microsoft.UI.Xaml.Controls.TreeView' | 'Microsoft.UI.Xaml.Controls.TreeViewItem' | 'Microsoft.UI.Xaml.Controls.TreeViewList' | 'Microsoft.UI.Xaml.Controls.TwoPaneView' | 'Microsoft.UI.Xaml.Controls.WebView2' | 'Windows.UI.Xaml.FrameworkElement' | 'Windows.UI.Xaml.Controls.Control' | 'Windows.UI.Xaml.Controls.ContentControl' | 'Windows.UI.Xaml.Controls.AppBar' | 'Windows.UI.Xaml.Controls.Primitives.ButtonBase' | 'Windows.UI.Xaml.Controls.Button' | 'Windows.UI.Xaml.Controls.AppBarButton' | 'Windows.UI.Xaml.Controls.AppBarElementContainer' | 'Windows.UI.Xaml.Controls.AppBarSeparator' | 'Windows.UI.Xaml.Controls.Primitives.ToggleButton' | 'Windows.UI.Xaml.Controls.AppBarToggleButton' | 'Windows.UI.Xaml.Controls.ItemsControl' | 'Windows.UI.Xaml.Controls.AutoSuggestBox' | 'Windows.UI.Xaml.Controls.IconElement' | 'Windows.UI.Xaml.Controls.BitmapIcon' | 'Windows.UI.Xaml.Controls.Border' | 'Windows.UI.Xaml.Controls.CalendarDatePicker' | 'Windows.UI.Xaml.Controls.CalendarView' | 'Windows.UI.Xaml.Controls.CalendarViewDayItem' | 'Windows.UI.Xaml.Controls.Panel' | 'Windows.UI.Xaml.Controls.Canvas' | 'Windows.UI.Xaml.Controls.CaptureElement' | 'Windows.UI.Xaml.Controls.CheckBox' | 'Windows.UI.Xaml.Controls.ColorPicker' | 'Windows.UI.Xaml.Controls.Primitives.Selector' | 'Windows.UI.Xaml.Controls.ComboBox' | 'Windows.UI.Xaml.Controls.Primitives.SelectorItem' | 'Windows.UI.Xaml.Controls.ComboBoxItem' | 'Windows.UI.Xaml.Controls.CommandBar' | 'Windows.UI.Xaml.Controls.CommandBarOverflowPresenter' | 'Windows.UI.Xaml.Controls.ContentDialog' | 'Windows.UI.Xaml.Controls.ContentPresenter' | 'Windows.UI.Xaml.Controls.DatePicker' | 'Windows.UI.Xaml.Controls.DatePickerFlyoutPresenter' | 'Windows.UI.Xaml.Controls.DropDownButton' | 'Windows.UI.Xaml.Controls.FlipView' | 'Windows.UI.Xaml.Controls.FlipViewItem' | 'Windows.UI.Xaml.Controls.FlyoutPresenter' | 'Windows.UI.Xaml.Controls.FontIcon' | 'Windows.UI.Xaml.Controls.Frame' | 'Windows.UI.Xaml.Controls.Grid' | 'Windows.UI.Xaml.Controls.ListViewBase' | 'Windows.UI.Xaml.Controls.GridView' | 'Windows.UI.Xaml.Controls.ListViewBaseHeaderItem' | 'Windows.UI.Xaml.Controls.GridViewHeaderItem' | 'Windows.UI.Xaml.Controls.GridViewItem' | 'Windows.UI.Xaml.Controls.GroupItem' | 'Windows.UI.Xaml.Controls.HandwritingView' | 'Windows.UI.Xaml.Controls.Hub' | 'Windows.UI.Xaml.Controls.HubSection' | 'Windows.UI.Xaml.Controls.HyperlinkButton' | 'Windows.UI.Xaml.Controls.IconSourceElement' | 'Windows.UI.Xaml.Controls.Image' | 'Windows.UI.Xaml.Controls.InkCanvas' | 'Windows.UI.Xaml.Controls.InkToolbar' | 'Windows.UI.Xaml.Controls.RadioButton' | 'Windows.UI.Xaml.Controls.InkToolbarToolButton' | 'Windows.UI.Xaml.Controls.InkToolbarPenButton' | 'Windows.UI.Xaml.Controls.InkToolbarBallpointPenButton' | 'Windows.UI.Xaml.Controls.InkToolbarCustomPenButton' | 'Windows.UI.Xaml.Controls.InkToolbarToggleButton' | 'Windows.UI.Xaml.Controls.InkToolbarCustomToggleButton' | 'Windows.UI.Xaml.Controls.InkToolbarCustomToolButton' | 'Windows.UI.Xaml.Controls.InkToolbarEraserButton' | 'Windows.UI.Xaml.Controls.InkToolbarFlyoutItem' | 'Windows.UI.Xaml.Controls.InkToolbarHighlighterButton' | 'Windows.UI.Xaml.Controls.InkToolbarMenuButton' | 'Windows.UI.Xaml.Controls.InkToolbarPenConfigurationControl' | 'Windows.UI.Xaml.Controls.InkToolbarPencilButton' | 'Windows.UI.Xaml.Controls.InkToolbarRulerButton' | 'Windows.UI.Xaml.Controls.InkToolbarStencilButton' | 'Windows.UI.Xaml.Controls.ItemsPresenter' | 'Windows.UI.Xaml.Controls.ItemsStackPanel' | 'Windows.UI.Xaml.Controls.ItemsWrapGrid' | 'Windows.UI.Xaml.Controls.ListBox' | 'Windows.UI.Xaml.Controls.ListBoxItem' | 'Windows.UI.Xaml.Controls.ListPickerFlyoutPresenter' | 'Windows.UI.Xaml.Controls.ListView' | 'Windows.UI.Xaml.Controls.ListViewHeaderItem' | 'Windows.UI.Xaml.Controls.ListViewItem' | 'Windows.UI.Xaml.Controls.Maps.MapControl' | 'Windows.UI.Xaml.Controls.MediaElement' | 'Windows.UI.Xaml.Controls.MediaPlayerElement' | 'Windows.UI.Xaml.Controls.MediaPlayerPresenter' | 'Windows.UI.Xaml.Controls.MediaTransportControls' | 'Windows.UI.Xaml.Controls.MenuBar' | 'Windows.UI.Xaml.Controls.MenuBarItem' | 'Windows.UI.Xaml.Controls.MenuFlyoutItemBase' | 'Windows.UI.Xaml.Controls.MenuFlyoutItem' | 'Windows.UI.Xaml.Controls.MenuFlyoutPresenter' | 'Windows.UI.Xaml.Controls.MenuFlyoutSeparator' | 'Windows.UI.Xaml.Controls.MenuFlyoutSubItem' | 'Windows.UI.Xaml.Controls.NavigationView' | 'Windows.UI.Xaml.Controls.NavigationViewItemBase' | 'Windows.UI.Xaml.Controls.NavigationViewItem' | 'Windows.UI.Xaml.Controls.NavigationViewItemHeader' | 'Windows.UI.Xaml.Controls.NavigationViewItemSeparator' | 'Windows.UI.Xaml.Controls.NavigationViewList' | 'Windows.UI.Xaml.Controls.UserControl' | 'Windows.UI.Xaml.Controls.Page' | 'Windows.UI.Xaml.Controls.ParallaxView' | 'Windows.UI.Xaml.Controls.PasswordBox' | 'Windows.UI.Xaml.Controls.PathIcon' | 'Windows.UI.Xaml.Controls.PersonPicture' | 'Windows.UI.Xaml.Controls.PickerFlyoutPresenter' | 'Windows.UI.Xaml.Controls.Pivot' | 'Windows.UI.Xaml.Controls.PivotItem' | 'Windows.UI.Xaml.Controls.Primitives.CalendarPanel' | 'Windows.UI.Xaml.Controls.VirtualizingPanel' | 'Windows.UI.Xaml.Controls.Primitives.CarouselPanel' | 'Windows.UI.Xaml.Controls.Primitives.RangeBase' | 'Windows.UI.Xaml.Controls.Slider' | 'Windows.UI.Xaml.Controls.Primitives.ColorPickerSlider' | 'Windows.UI.Xaml.Controls.Primitives.ColorSpectrum' | 'Windows.UI.Xaml.Controls.Primitives.CommandBarFlyoutCommandBar' | 'Windows.UI.Xaml.Controls.Primitives.GridViewItemPresenter' | 'Windows.UI.Xaml.Controls.Primitives.ListViewItemPresenter' | 'Windows.UI.Xaml.Controls.Primitives.LoopingSelector' | 'Windows.UI.Xaml.Controls.Primitives.LoopingSelectorItem' | 'Windows.UI.Xaml.Controls.Primitives.LoopingSelectorPanel' | 'Windows.UI.Xaml.Controls.Primitives.NavigationViewItemPresenter' | 'Windows.UI.Xaml.Controls.Primitives.OrientedVirtualizingPanel' | 'Windows.UI.Xaml.Controls.Primitives.PivotHeaderItem' | 'Windows.UI.Xaml.Controls.Primitives.PivotHeaderPanel' | 'Windows.UI.Xaml.Controls.Primitives.PivotPanel' | 'Windows.UI.Xaml.Controls.Primitives.Popup' | 'Windows.UI.Xaml.Controls.Primitives.RepeatButton' | 'Windows.UI.Xaml.Controls.Primitives.ScrollBar' | 'Windows.UI.Xaml.Controls.Primitives.Thumb' | 'Windows.UI.Xaml.Controls.Primitives.TickBar' | 'Windows.UI.Xaml.Controls.ProgressBar' | 'Windows.UI.Xaml.Controls.ProgressRing' | 'Windows.UI.Xaml.Controls.RatingControl' | 'Windows.UI.Xaml.Controls.RefreshContainer' | 'Windows.UI.Xaml.Controls.RefreshVisualizer' | 'Windows.UI.Xaml.Controls.RelativePanel' | 'Windows.UI.Xaml.Controls.RichEditBox' | 'Windows.UI.Xaml.Controls.RichTextBlock' | 'Windows.UI.Xaml.Controls.RichTextBlockOverflow' | 'Windows.UI.Xaml.Controls.ScrollContentPresenter' | 'Windows.UI.Xaml.Controls.ScrollViewer' | 'Windows.UI.Xaml.Controls.SearchBox' | 'Windows.UI.Xaml.Controls.SemanticZoom' | 'Windows.UI.Xaml.Controls.SettingsFlyout' | 'Windows.UI.Xaml.Controls.SplitButton' | 'Windows.UI.Xaml.Controls.SplitView' | 'Windows.UI.Xaml.Controls.StackPanel' | 'Windows.UI.Xaml.Controls.SwapChainBackgroundPanel' | 'Windows.UI.Xaml.Controls.SwapChainPanel' | 'Windows.UI.Xaml.Controls.SwipeControl' | 'Windows.UI.Xaml.Controls.SymbolIcon' | 'Windows.UI.Xaml.Controls.TextBlock' | 'Windows.UI.Xaml.Controls.TextBox' | 'Windows.UI.Xaml.Controls.TimePicker' | 'Windows.UI.Xaml.Controls.TimePickerFlyoutPresenter' | 'Windows.UI.Xaml.Controls.ToggleMenuFlyoutItem' | 'Windows.UI.Xaml.Controls.ToggleSplitButton' | 'Windows.UI.Xaml.Controls.ToggleSwitch' | 'Windows.UI.Xaml.Controls.ToolTip' | 'Windows.UI.Xaml.Controls.TreeView' | 'Windows.UI.Xaml.Controls.TreeViewItem' | 'Windows.UI.Xaml.Controls.TreeViewList' | 'Windows.UI.Xaml.Controls.TwoPaneView' | 'Windows.UI.Xaml.Controls.VariableSizedWrapGrid' | 'Windows.UI.Xaml.Controls.Viewbox' | 'Windows.UI.Xaml.Controls.VirtualizingStackPanel' | 'Windows.UI.Xaml.Controls.WebView' | 'Windows.UI.Xaml.Controls.WrapGrid' | 'Windows.UI.Xaml.Documents.Glyphs' | 'Windows.UI.Xaml.Shapes.Shape' | 'Windows.UI.Xaml.Shapes.Ellipse' | 'Windows.UI.Xaml.Shapes.Line' | 'Windows.UI.Xaml.Shapes.Path' | 'Windows.UI.Xaml.Shapes.Polygon' | 'Windows.UI.Xaml.Shapes.Polyline' | 'Windows.UI.Xaml.Shapes.Rectangle';
    opacity?: number;
...
export interface NativeFrameworkElementProps extends NativeUIElementProps {
    type: 'Windows.UI.Xaml.FrameworkElement' | 'Microsoft.UI.Xaml.Controls.AnimatedIcon' | 'Microsoft.UI.Xaml.Controls.AnimatedVisualPlayer' | 'Microsoft.UI.Xaml.Controls.BreadcrumbBar' | 'Microsoft.UI.Xaml.Controls.BreadcrumbBarItem' | 'Microsoft.UI.Xaml.Controls.ColorPicker' | 'Microsoft.UI.Xaml.Controls.DropDownButton' | 'Microsoft.UI.Xaml.Controls.Expander' | 'Microsoft.UI.Xaml.Controls.ImageIcon' | 'Microsoft.UI.Xaml.Controls.InfoBadge' | 'Microsoft.UI.Xaml.Controls.InfoBar' | 'Microsoft.UI.Xaml.Controls.ItemsRepeater' | 'Microsoft.UI.Xaml.Controls.ItemsRepeaterScrollHost' | 'Microsoft.UI.Xaml.Controls.MenuBar' | 'Microsoft.UI.Xaml.Controls.MenuBarItem' | 'Microsoft.UI.Xaml.Controls.NavigationView' | 'Microsoft.UI.Xaml.Controls.NavigationViewItemBase' | 'Microsoft.UI.Xaml.Controls.NavigationViewItem' | 'Microsoft.UI.Xaml.Controls.NavigationViewItemHeader' | 'Microsoft.UI.Xaml.Controls.NavigationViewItemSeparator' | 'Microsoft.UI.Xaml.Controls.NumberBox' | 'Microsoft.UI.Xaml.Controls.ParallaxView' | 'Microsoft.UI.Xaml.Controls.PersonPicture' | 'Microsoft.UI.Xaml.Controls.PipsPager' | 'Microsoft.UI.Xaml.Controls.Primitives.ColorPickerSlider' | 'Microsoft.UI.Xaml.Controls.Primitives.ColorSpectrum' | 'Microsoft.UI.Xaml.Controls.Primitives.CommandBarFlyoutCommandBar' | 'Microsoft.UI.Xaml.Controls.Primitives.InfoBarPanel' | 'Microsoft.UI.Xaml.Controls.Primitives.MonochromaticOverlayPresenter' | 'Microsoft.UI.Xaml.Controls.Primitives.NavigationViewItemPresenter' | 'Microsoft.UI.Xaml.Controls.Primitives.TabViewListView' | 'Microsoft.UI.Xaml.Controls.ProgressBar' | 'Microsoft.UI.Xaml.Controls.ProgressRing' | 'Microsoft.UI.Xaml.Controls.RadioButtons' | 'Microsoft.UI.Xaml.Controls.RadioMenuFlyoutItem' | 'Microsoft.UI.Xaml.Controls.RatingControl' | 'Microsoft.UI.Xaml.Controls.RefreshContainer' | 'Microsoft.UI.Xaml.Controls.RefreshVisualizer' | 'Microsoft.UI.Xaml.Controls.RevealListViewItemPresenter' | 'Microsoft.UI.Xaml.Controls.SplitButton' | 'Microsoft.UI.Xaml.Controls.SwipeControl' | 'Microsoft.UI.Xaml.Controls.TabView' | 'Microsoft.UI.Xaml.Controls.TabViewItem' | 'Microsoft.UI.Xaml.Controls.TeachingTip' | 'Microsoft.UI.Xaml.Controls.ToggleSplitButton' | 'Microsoft.UI.Xaml.Controls.TreeView' | 'Microsoft.UI.Xaml.Controls.TreeViewItem' | 'Microsoft.UI.Xaml.Controls.TreeViewList' | 'Microsoft.UI.Xaml.Controls.TwoPaneView' | 'Microsoft.UI.Xaml.Controls.WebView2' | 'Windows.UI.Xaml.Controls.Control' | 'Windows.UI.Xaml.Controls.ContentControl' | 'Windows.UI.Xaml.Controls.AppBar' | 'Windows.UI.Xaml.Controls.Primitives.ButtonBase' | 'Windows.UI.Xaml.Controls.Button' | 'Windows.UI.Xaml.Controls.AppBarButton' | 'Windows.UI.Xaml.Controls.AppBarElementContainer' | 'Windows.UI.Xaml.Controls.AppBarSeparator' | 'Windows.UI.Xaml.Controls.Primitives.ToggleButton' | 'Windows.UI.Xaml.Controls.AppBarToggleButton' | 'Windows.UI.Xaml.Controls.ItemsControl' | 'Windows.UI.Xaml.Controls.AutoSuggestBox' | 'Windows.UI.Xaml.Controls.IconElement' | 'Windows.UI.Xaml.Controls.BitmapIcon' | 'Windows.UI.Xaml.Controls.Border' | 'Windows.UI.Xaml.Controls.CalendarDatePicker' | 'Windows.UI.Xaml.Controls.CalendarView' | 'Windows.UI.Xaml.Controls.CalendarViewDayItem' | 'Windows.UI.Xaml.Controls.Panel' | 'Windows.UI.Xaml.Controls.Canvas' | 'Windows.UI.Xaml.Controls.CaptureElement' | 'Windows.UI.Xaml.Controls.CheckBox' | 'Windows.UI.Xaml.Controls.ColorPicker' | 'Windows.UI.Xaml.Controls.Primitives.Selector' | 'Windows.UI.Xaml.Controls.ComboBox' | 'Windows.UI.Xaml.Controls.Primitives.SelectorItem' | 'Windows.UI.Xaml.Controls.ComboBoxItem' | 'Windows.UI.Xaml.Controls.CommandBar' | 'Windows.UI.Xaml.Controls.CommandBarOverflowPresenter' | 'Windows.UI.Xaml.Controls.ContentDialog' | 'Windows.UI.Xaml.Controls.ContentPresenter' | 'Windows.UI.Xaml.Controls.DatePicker' | 'Windows.UI.Xaml.Controls.DatePickerFlyoutPresenter' | 'Windows.UI.Xaml.Controls.DropDownButton' | 'Windows.UI.Xaml.Controls.FlipView' | 'Windows.UI.Xaml.Controls.FlipViewItem' | 'Windows.UI.Xaml.Controls.FlyoutPresenter' | 'Windows.UI.Xaml.Controls.FontIcon' | 'Windows.UI.Xaml.Controls.Frame' | 'Windows.UI.Xaml.Controls.Grid' | 'Windows.UI.Xaml.Controls.ListViewBase' | 'Windows.UI.Xaml.Controls.GridView' | 'Windows.UI.Xaml.Controls.ListViewBaseHeaderItem' | 'Windows.UI.Xaml.Controls.GridViewHeaderItem' | 'Windows.UI.Xaml.Controls.GridViewItem' | 'Windows.UI.Xaml.Controls.GroupItem' | 'Windows.UI.Xaml.Controls.HandwritingView' | 'Windows.UI.Xaml.Controls.Hub' | 'Windows.UI.Xaml.Controls.HubSection' | 'Windows.UI.Xaml.Controls.HyperlinkButton' | 'Windows.UI.Xaml.Controls.IconSourceElement' | 'Windows.UI.Xaml.Controls.Image' | 'Windows.UI.Xaml.Controls.InkCanvas' | 'Windows.UI.Xaml.Controls.InkToolbar' | 'Windows.UI.Xaml.Controls.RadioButton' | 'Windows.UI.Xaml.Controls.InkToolbarToolButton' | 'Windows.UI.Xaml.Controls.InkToolbarPenButton' | 'Windows.UI.Xaml.Controls.InkToolbarBallpointPenButton' | 'Windows.UI.Xaml.Controls.InkToolbarCustomPenButton' | 'Windows.UI.Xaml.Controls.InkToolbarToggleButton' | 'Windows.UI.Xaml.Controls.InkToolbarCustomToggleButton' | 'Windows.UI.Xaml.Controls.InkToolbarCustomToolButton' | 'Windows.UI.Xaml.Controls.InkToolbarEraserButton' | 'Windows.UI.Xaml.Controls.InkToolbarFlyoutItem' | 'Windows.UI.Xaml.Controls.InkToolbarHighlighterButton' | 'Windows.UI.Xaml.Controls.InkToolbarMenuButton' | 'Windows.UI.Xaml.Controls.InkToolbarPenConfigurationControl' | 'Windows.UI.Xaml.Controls.InkToolbarPencilButton' | 'Windows.UI.Xaml.Controls.InkToolbarRulerButton' | 'Windows.UI.Xaml.Controls.InkToolbarStencilButton' | 'Windows.UI.Xaml.Controls.ItemsPresenter' | 'Windows.UI.Xaml.Controls.ItemsStackPanel' | 'Windows.UI.Xaml.Controls.ItemsWrapGrid' | 'Windows.UI.Xaml.Controls.ListBox' | 'Windows.UI.Xaml.Controls.ListBoxItem' | 'Windows.UI.Xaml.Controls.ListPickerFlyoutPresenter' | 'Windows.UI.Xaml.Controls.ListView' | 'Windows.UI.Xaml.Controls.ListViewHeaderItem' | 'Windows.UI.Xaml.Controls.ListViewItem' | 'Windows.UI.Xaml.Controls.Maps.MapControl' | 'Windows.UI.Xaml.Controls.MediaElement' | 'Windows.UI.Xaml.Controls.MediaPlayerElement' | 'Windows.UI.Xaml.Controls.MediaPlayerPresenter' | 'Windows.UI.Xaml.Controls.MediaTransportControls' | 'Windows.UI.Xaml.Controls.MenuBar' | 'Windows.UI.Xaml.Controls.MenuBarItem' | 'Windows.UI.Xaml.Controls.MenuFlyoutItemBase' | 'Windows.UI.Xaml.Controls.MenuFlyoutItem' | 'Windows.UI.Xaml.Controls.MenuFlyoutPresenter' | 'Windows.UI.Xaml.Controls.MenuFlyoutSeparator' | 'Windows.UI.Xaml.Controls.MenuFlyoutSubItem' | 'Windows.UI.Xaml.Controls.NavigationView' | 'Windows.UI.Xaml.Controls.NavigationViewItemBase' | 'Windows.UI.Xaml.Controls.NavigationViewItem' | 'Windows.UI.Xaml.Controls.NavigationViewItemHeader' | 'Windows.UI.Xaml.Controls.NavigationViewItemSeparator' | 'Windows.UI.Xaml.Controls.NavigationViewList' | 'Windows.UI.Xaml.Controls.UserControl' | 'Windows.UI.Xaml.Controls.Page' | 'Windows.UI.Xaml.Controls.ParallaxView' | 'Windows.UI.Xaml.Controls.PasswordBox' | 'Windows.UI.Xaml.Controls.PathIcon' | 'Windows.UI.Xaml.Controls.PersonPicture' | 'Windows.UI.Xaml.Controls.PickerFlyoutPresenter' | 'Windows.UI.Xaml.Controls.Pivot' | 'Windows.UI.Xaml.Controls.PivotItem' | 'Windows.UI.Xaml.Controls.Primitives.CalendarPanel' | 'Windows.UI.Xaml.Controls.VirtualizingPanel' | 'Windows.UI.Xaml.Controls.Primitives.CarouselPanel' | 'Windows.UI.Xaml.Controls.Primitives.RangeBase' | 'Windows.UI.Xaml.Controls.Slider' | 'Windows.UI.Xaml.Controls.Primitives.ColorPickerSlider' | 'Windows.UI.Xaml.Controls.Primitives.ColorSpectrum' | 'Windows.UI.Xaml.Controls.Primitives.CommandBarFlyoutCommandBar' | 'Windows.UI.Xaml.Controls.Primitives.GridViewItemPresenter' | 'Windows.UI.Xaml.Controls.Primitives.ListViewItemPresenter' | 'Windows.UI.Xaml.Controls.Primitives.LoopingSelector' | 'Windows.UI.Xaml.Controls.Primitives.LoopingSelectorItem' | 'Windows.UI.Xaml.Controls.Primitives.LoopingSelectorPanel' | 'Windows.UI.Xaml.Controls.Primitives.NavigationViewItemPresenter' | 'Windows.UI.Xaml.Controls.Primitives.OrientedVirtualizingPanel' | 'Windows.UI.Xaml.Controls.Primitives.PivotHeaderItem' | 'Windows.UI.Xaml.Controls.Primitives.PivotHeaderPanel' | 'Windows.UI.Xaml.Controls.Primitives.PivotPanel' | 'Windows.UI.Xaml.Controls.Primitives.Popup' | 'Windows.UI.Xaml.Controls.Primitives.RepeatButton' | 'Windows.UI.Xaml.Controls.Primitives.ScrollBar' | 'Windows.UI.Xaml.Controls.Primitives.Thumb' | 'Windows.UI.Xaml.Controls.Primitives.TickBar' | 'Windows.UI.Xaml.Controls.ProgressBar' | 'Windows.UI.Xaml.Controls.ProgressRing' | 'Windows.UI.Xaml.Controls.RatingControl' | 'Windows.UI.Xaml.Controls.RefreshContainer' | 'Windows.UI.Xaml.Controls.RefreshVisualizer' | 'Windows.UI.Xaml.Controls.RelativePanel' | 'Windows.UI.Xaml.Controls.RichEditBox' | 'Windows.UI.Xaml.Controls.RichTextBlock' | 'Windows.UI.Xaml.Controls.RichTextBlockOverflow' | 'Windows.UI.Xaml.Controls.ScrollContentPresenter' | 'Windows.UI.Xaml.Controls.ScrollViewer' | 'Windows.UI.Xaml.Controls.SearchBox' | 'Windows.UI.Xaml.Controls.SemanticZoom' | 'Windows.UI.Xaml.Controls.SettingsFlyout' | 'Windows.UI.Xaml.Controls.SplitButton' | 'Windows.UI.Xaml.Controls.SplitView' | 'Windows.UI.Xaml.Controls.StackPanel' | 'Windows.UI.Xaml.Controls.SwapChainBackgroundPanel' | 'Windows.UI.Xaml.Controls.SwapChainPanel' | 'Windows.UI.Xaml.Controls.SwipeControl' | 'Windows.UI.Xaml.Controls.SymbolIcon' | 'Windows.UI.Xaml.Controls.TextBlock' | 'Windows.UI.Xaml.Controls.TextBox' | 'Windows.UI.Xaml.Controls.TimePicker' | 'Windows.UI.Xaml.Controls.TimePickerFlyoutPresenter' | 'Windows.UI.Xaml.Controls.ToggleMenuFlyoutItem' | 'Windows.UI.Xaml.Controls.ToggleSplitButton' | 'Windows.UI.Xaml.Controls.ToggleSwitch' | 'Windows.UI.Xaml.Controls.ToolTip' | 'Windows.UI.Xaml.Controls.TreeView' | 'Windows.UI.Xaml.Controls.TreeViewItem' | 'Windows.UI.Xaml.Controls.TreeViewList' | 'Windows.UI.Xaml.Controls.TwoPaneView' | 'Windows.UI.Xaml.Controls.VariableSizedWrapGrid' | 'Windows.UI.Xaml.Controls.Viewbox' | 'Windows.UI.Xaml.Controls.VirtualizingStackPanel' | 'Windows.UI.Xaml.Controls.WebView' | 'Windows.UI.Xaml.Controls.WrapGrid' | 'Windows.UI.Xaml.Documents.Glyphs' | 'Windows.UI.Xaml.Shapes.Shape' | 'Windows.UI.Xaml.Shapes.Ellipse' | 'Windows.UI.Xaml.Shapes.Line' | 'Windows.UI.Xaml.Shapes.Path' | 'Windows.UI.Xaml.Shapes.Polygon' | 'Windows.UI.Xaml.Shapes.Polyline' | 'Windows.UI.Xaml.Shapes.Rectangle';
    width?: number;
...
export interface NativeControlProps extends NativeFrameworkElementProps {
    type: 'Windows.UI.Xaml.Controls.Control' | 'Microsoft.UI.Xaml.Controls.BreadcrumbBar' | 'Microsoft.UI.Xaml.Controls.BreadcrumbBarItem' | 'Microsoft.UI.Xaml.Controls.ColorPicker' | 'Microsoft.UI.Xaml.Controls.DropDownButton' | 'Microsoft.UI.Xaml.Controls.Expander' | 'Microsoft.UI.Xaml.Controls.InfoBadge' | 'Microsoft.UI.Xaml.Controls.InfoBar' | 'Microsoft.UI.Xaml.Controls.MenuBar' | 'Microsoft.UI.Xaml.Controls.MenuBarItem' | 'Microsoft.UI.Xaml.Controls.NavigationView' | 'Microsoft.UI.Xaml.Controls.NavigationViewItemBase' | 'Microsoft.UI.Xaml.Controls.NavigationViewItem' | 'Microsoft.UI.Xaml.Controls.NavigationViewItemHeader' | 'Microsoft.UI.Xaml.Controls.NavigationViewItemSeparator' | 'Microsoft.UI.Xaml.Controls.NumberBox' | 'Microsoft.UI.Xaml.Controls.PersonPicture' | 'Microsoft.UI.Xaml.Controls.PipsPager' | 'Microsoft.UI.Xaml.Controls.Primitives.ColorPickerSlider' | 'Microsoft.UI.Xaml.Controls.Primitives.ColorSpectrum' | 'Microsoft.UI.Xaml.Controls.Primitives.CommandBarFlyoutCommandBar' | 'Microsoft.UI.Xaml.Controls.Primitives.NavigationViewItemPresenter' | 'Microsoft.UI.Xaml.Controls.Primitives.TabViewListView' | 'Microsoft.UI.Xaml.Controls.ProgressBar' | 'Microsoft.UI.Xaml.Controls.ProgressRing' | 'Microsoft.UI.Xaml.Controls.RadioButtons' | 'Microsoft.UI.Xaml.Controls.RadioMenuFlyoutItem' | 'Microsoft.UI.Xaml.Controls.RatingControl' | 'Microsoft.UI.Xaml.Controls.RefreshContainer' | 'Microsoft.UI.Xaml.Controls.RefreshVisualizer' | 'Microsoft.UI.Xaml.Controls.SplitButton' | 'Microsoft.UI.Xaml.Controls.SwipeControl' | 'Microsoft.UI.Xaml.Controls.TabView' | 'Microsoft.UI.Xaml.Controls.TabViewItem' | 'Microsoft.UI.Xaml.Controls.TeachingTip' | 'Microsoft.UI.Xaml.Controls.ToggleSplitButton' | 'Microsoft.UI.Xaml.Controls.TreeView' | 'Microsoft.UI.Xaml.Controls.TreeViewItem' | 'Microsoft.UI.Xaml.Controls.TreeViewList' | 'Microsoft.UI.Xaml.Controls.TwoPaneView' | 'Microsoft.UI.Xaml.Controls.WebView2' | 'Windows.UI.Xaml.Controls.ContentControl' | 'Windows.UI.Xaml.Controls.AppBar' | 'Windows.UI.Xaml.Controls.Primitives.ButtonBase' | 'Windows.UI.Xaml.Controls.Button' | 'Windows.UI.Xaml.Controls.AppBarButton' | 'Windows.UI.Xaml.Controls.AppBarElementContainer' | 'Windows.UI.Xaml.Controls.AppBarSeparator' | 'Windows.UI.Xaml.Controls.Primitives.ToggleButton' | 'Windows.UI.Xaml.Controls.AppBarToggleButton' | 'Windows.UI.Xaml.Controls.ItemsControl' | 'Windows.UI.Xaml.Controls.AutoSuggestBox' | 'Windows.UI.Xaml.Controls.CalendarDatePicker' | 'Windows.UI.Xaml.Controls.CalendarView' | 'Windows.UI.Xaml.Controls.CalendarViewDayItem' | 'Windows.UI.Xaml.Controls.CheckBox' | 'Windows.UI.Xaml.Controls.ColorPicker' | 'Windows.UI.Xaml.Controls.Primitives.Selector' | 'Windows.UI.Xaml.Controls.ComboBox' | 'Windows.UI.Xaml.Controls.Primitives.SelectorItem' | 'Windows.UI.Xaml.Controls.ComboBoxItem' | 'Windows.UI.Xaml.Controls.CommandBar' | 'Windows.UI.Xaml.Controls.CommandBarOverflowPresenter' | 'Windows.UI.Xaml.Controls.ContentDialog' | 'Windows.UI.Xaml.Controls.DatePicker' | 'Windows.UI.Xaml.Controls.DatePickerFlyoutPresenter' | 'Windows.UI.Xaml.Controls.DropDownButton' | 'Windows.UI.Xaml.Controls.FlipView' | 'Windows.UI.Xaml.Controls.FlipViewItem' | 'Windows.UI.Xaml.Controls.FlyoutPresenter' | 'Windows.UI.Xaml.Controls.Frame' | 'Windows.UI.Xaml.Controls.ListViewBase' | 'Windows.UI.Xaml.Controls.GridView' | 'Windows.UI.Xaml.Controls.ListViewBaseHeaderItem' | 'Windows.UI.Xaml.Controls.GridViewHeaderItem' | 'Windows.UI.Xaml.Controls.GridViewItem' | 'Windows.UI.Xaml.Controls.GroupItem' | 'Windows.UI.Xaml.Controls.HandwritingView' | 'Windows.UI.Xaml.Controls.Hub' | 'Windows.UI.Xaml.Controls.HubSection' | 'Windows.UI.Xaml.Controls.HyperlinkButton' | 'Windows.UI.Xaml.Controls.InkToolbar' | 'Windows.UI.Xaml.Controls.RadioButton' | 'Windows.UI.Xaml.Controls.InkToolbarToolButton' | 'Windows.UI.Xaml.Controls.InkToolbarPenButton' | 'Windows.UI.Xaml.Controls.InkToolbarBallpointPenButton' | 'Windows.UI.Xaml.Controls.InkToolbarCustomPenButton' | 'Windows.UI.Xaml.Controls.InkToolbarToggleButton' | 'Windows.UI.Xaml.Controls.InkToolbarCustomToggleButton' | 'Windows.UI.Xaml.Controls.InkToolbarCustomToolButton' | 'Windows.UI.Xaml.Controls.InkToolbarEraserButton' | 'Windows.UI.Xaml.Controls.InkToolbarFlyoutItem' | 'Windows.UI.Xaml.Controls.InkToolbarHighlighterButton' | 'Windows.UI.Xaml.Controls.InkToolbarMenuButton' | 'Windows.UI.Xaml.Controls.InkToolbarPenConfigurationControl' | 'Windows.UI.Xaml.Controls.InkToolbarPencilButton' | 'Windows.UI.Xaml.Controls.InkToolbarRulerButton' | 'Windows.UI.Xaml.Controls.InkToolbarStencilButton' | 'Windows.UI.Xaml.Controls.ListBox' | 'Windows.UI.Xaml.Controls.ListBoxItem' | 'Windows.UI.Xaml.Controls.ListPickerFlyoutPresenter' | 'Windows.UI.Xaml.Controls.ListView' | 'Windows.UI.Xaml.Controls.ListViewHeaderItem' | 'Windows.UI.Xaml.Controls.ListViewItem' | 'Windows.UI.Xaml.Controls.Maps.MapControl' | 'Windows.UI.Xaml.Controls.MediaPlayerElement' | 'Windows.UI.Xaml.Controls.MediaTransportControls' | 'Windows.UI.Xaml.Controls.MenuBar' | 'Windows.UI.Xaml.Controls.MenuBarItem' | 'Windows.UI.Xaml.Controls.MenuFlyoutItemBase' | 'Windows.UI.Xaml.Controls.MenuFlyoutItem' | 'Windows.UI.Xaml.Controls.MenuFlyoutPresenter' | 'Windows.UI.Xaml.Controls.MenuFlyoutSeparator' | 'Windows.UI.Xaml.Controls.MenuFlyoutSubItem' | 'Windows.UI.Xaml.Controls.NavigationView' | 'Windows.UI.Xaml.Controls.NavigationViewItemBase' | 'Windows.UI.Xaml.Controls.NavigationViewItem' | 'Windows.UI.Xaml.Controls.NavigationViewItemHeader' | 'Windows.UI.Xaml.Controls.NavigationViewItemSeparator' | 'Windows.UI.Xaml.Controls.NavigationViewList' | 'Windows.UI.Xaml.Controls.UserControl' | 'Windows.UI.Xaml.Controls.Page' | 'Windows.UI.Xaml.Controls.PasswordBox' | 'Windows.UI.Xaml.Controls.PersonPicture' | 'Windows.UI.Xaml.Controls.PickerFlyoutPresenter' | 'Windows.UI.Xaml.Controls.Pivot' | 'Windows.UI.Xaml.Controls.PivotItem' | 'Windows.UI.Xaml.Controls.Primitives.RangeBase' | 'Windows.UI.Xaml.Controls.Slider' | 'Windows.UI.Xaml.Controls.Primitives.ColorPickerSlider' | 'Windows.UI.Xaml.Controls.Primitives.ColorSpectrum' | 'Windows.UI.Xaml.Controls.Primitives.CommandBarFlyoutCommandBar' | 'Windows.UI.Xaml.Controls.Primitives.LoopingSelector' | 'Windows.UI.Xaml.Controls.Primitives.LoopingSelectorItem' | 'Windows.UI.Xaml.Controls.Primitives.NavigationViewItemPresenter' | 'Windows.UI.Xaml.Controls.Primitives.PivotHeaderItem' | 'Windows.UI.Xaml.Controls.Primitives.RepeatButton' | 'Windows.UI.Xaml.Controls.Primitives.ScrollBar' | 'Windows.UI.Xaml.Controls.Primitives.Thumb' | 'Windows.UI.Xaml.Controls.ProgressBar' | 'Windows.UI.Xaml.Controls.ProgressRing' | 'Windows.UI.Xaml.Controls.RatingControl' | 'Windows.UI.Xaml.Controls.RefreshContainer' | 'Windows.UI.Xaml.Controls.RefreshVisualizer' | 'Windows.UI.Xaml.Controls.RichEditBox' | 'Windows.UI.Xaml.Controls.ScrollViewer' | 'Windows.UI.Xaml.Controls.SearchBox' | 'Windows.UI.Xaml.Controls.SemanticZoom' | 'Windows.UI.Xaml.Controls.SettingsFlyout' | 'Windows.UI.Xaml.Controls.SplitButton' | 'Windows.UI.Xaml.Controls.SplitView' | 'Windows.UI.Xaml.Controls.SwipeControl' | 'Windows.UI.Xaml.Controls.TextBox' | 'Windows.UI.Xaml.Controls.TimePicker' | 'Windows.UI.Xaml.Controls.TimePickerFlyoutPresenter' | 'Windows.UI.Xaml.Controls.ToggleMenuFlyoutItem' | 'Windows.UI.Xaml.Controls.ToggleSplitButton' | 'Windows.UI.Xaml.Controls.ToggleSwitch' | 'Windows.UI.Xaml.Controls.ToolTip' | 'Windows.UI.Xaml.Controls.TreeView' | 'Windows.UI.Xaml.Controls.TreeViewItem' | 'Windows.UI.Xaml.Controls.TreeViewList' | 'Windows.UI.Xaml.Controls.TwoPaneView';
...
export interface NativeContentControlProps extends NativeControlProps {
    type: 'Windows.UI.Xaml.Controls.ContentControl' | 'Microsoft.UI.Xaml.Controls.BreadcrumbBarItem' | 'Microsoft.UI.Xaml.Controls.DropDownButton' | 'Microsoft.UI.Xaml.Controls.Expander' | 'Microsoft.UI.Xaml.Controls.NavigationView' | 'Microsoft.UI.Xaml.Controls.NavigationViewItemBase' | 'Microsoft.UI.Xaml.Controls.NavigationViewItem' | 'Microsoft.UI.Xaml.Controls.NavigationViewItemHeader' | 'Microsoft.UI.Xaml.Controls.NavigationViewItemSeparator' | 'Microsoft.UI.Xaml.Controls.Primitives.CommandBarFlyoutCommandBar' | 'Microsoft.UI.Xaml.Controls.Primitives.NavigationViewItemPresenter' | 'Microsoft.UI.Xaml.Controls.RefreshContainer' | 'Microsoft.UI.Xaml.Controls.SplitButton' | 'Microsoft.UI.Xaml.Controls.SwipeControl' | 'Microsoft.UI.Xaml.Controls.TabViewItem' | 'Microsoft.UI.Xaml.Controls.TeachingTip' | 'Microsoft.UI.Xaml.Controls.ToggleSplitButton' | 'Microsoft.UI.Xaml.Controls.TreeViewItem' | 'Windows.UI.Xaml.Controls.AppBar' | 'Windows.UI.Xaml.Controls.Primitives.ButtonBase' | 'Windows.UI.Xaml.Controls.Button' | 'Windows.UI.Xaml.Controls.AppBarButton' | 'Windows.UI.Xaml.Controls.AppBarElementContainer' | 'Windows.UI.Xaml.Controls.Primitives.ToggleButton' | 'Windows.UI.Xaml.Controls.AppBarToggleButton' | 'Windows.UI.Xaml.Controls.CheckBox' | 'Windows.UI.Xaml.Controls.Primitives.SelectorItem' | 'Windows.UI.Xaml.Controls.ComboBoxItem' | 'Windows.UI.Xaml.Controls.CommandBar' | 'Windows.UI.Xaml.Controls.ContentDialog' | 'Windows.UI.Xaml.Controls.DropDownButton' | 'Windows.UI.Xaml.Controls.FlipViewItem' | 'Windows.UI.Xaml.Controls.FlyoutPresenter' | 'Windows.UI.Xaml.Controls.Frame' | 'Windows.UI.Xaml.Controls.ListViewBaseHeaderItem' | 'Windows.UI.Xaml.Controls.GridViewHeaderItem' | 'Windows.UI.Xaml.Controls.GridViewItem' | 'Windows.UI.Xaml.Controls.GroupItem' | 'Windows.UI.Xaml.Controls.HyperlinkButton' | 'Windows.UI.Xaml.Controls.RadioButton' | 'Windows.UI.Xaml.Controls.InkToolbarToolButton' | 'Windows.UI.Xaml.Controls.InkToolbarPenButton' | 'Windows.UI.Xaml.Controls.InkToolbarBallpointPenButton' | 'Windows.UI.Xaml.Controls.InkToolbarCustomPenButton' | 'Windows.UI.Xaml.Controls.InkToolbarToggleButton' | 'Windows.UI.Xaml.Controls.InkToolbarCustomToggleButton' | 'Windows.UI.Xaml.Controls.InkToolbarCustomToolButton' | 'Windows.UI.Xaml.Controls.InkToolbarEraserButton' | 'Windows.UI.Xaml.Controls.InkToolbarFlyoutItem' | 'Windows.UI.Xaml.Controls.InkToolbarHighlighterButton' | 'Windows.UI.Xaml.Controls.InkToolbarMenuButton' | 'Windows.UI.Xaml.Controls.InkToolbarPencilButton' | 'Windows.UI.Xaml.Controls.InkToolbarRulerButton' | 'Windows.UI.Xaml.Controls.InkToolbarStencilButton' | 'Windows.UI.Xaml.Controls.ListBoxItem' | 'Windows.UI.Xaml.Controls.ListViewHeaderItem' | 'Windows.UI.Xaml.Controls.ListViewItem' | 'Windows.UI.Xaml.Controls.NavigationView' | 'Windows.UI.Xaml.Controls.NavigationViewItemBase' | 'Windows.UI.Xaml.Controls.NavigationViewItem' | 'Windows.UI.Xaml.Controls.NavigationViewItemHeader' | 'Windows.UI.Xaml.Controls.NavigationViewItemSeparator' | 'Windows.UI.Xaml.Controls.PickerFlyoutPresenter' | 'Windows.UI.Xaml.Controls.PivotItem' | 'Windows.UI.Xaml.Controls.Primitives.CommandBarFlyoutCommandBar' | 'Windows.UI.Xaml.Controls.Primitives.LoopingSelectorItem' | 'Windows.UI.Xaml.Controls.Primitives.NavigationViewItemPresenter' | 'Windows.UI.Xaml.Controls.Primitives.PivotHeaderItem' | 'Windows.UI.Xaml.Controls.Primitives.RepeatButton' | 'Windows.UI.Xaml.Controls.RefreshContainer' | 'Windows.UI.Xaml.Controls.ScrollViewer' | 'Windows.UI.Xaml.Controls.SettingsFlyout' | 'Windows.UI.Xaml.Controls.SplitButton' | 'Windows.UI.Xaml.Controls.SwipeControl' | 'Windows.UI.Xaml.Controls.ToggleSplitButton' | 'Windows.UI.Xaml.Controls.ToolTip' | 'Windows.UI.Xaml.Controls.TreeViewItem';
    content?: string;
}
...
export interface NativeButtonBaseProps extends NativeContentControlProps {
    type: 'Windows.UI.Xaml.Controls.Primitives.ButtonBase' | 'Microsoft.UI.Xaml.Controls.DropDownButton' | 'Windows.UI.Xaml.Controls.Button' | 'Windows.UI.Xaml.Controls.AppBarButton' | 'Windows.UI.Xaml.Controls.Primitives.ToggleButton' | 'Windows.UI.Xaml.Controls.AppBarToggleButton' | 'Windows.UI.Xaml.Controls.CheckBox' | 'Windows.UI.Xaml.Controls.DropDownButton' | 'Windows.UI.Xaml.Controls.HyperlinkButton' | 'Windows.UI.Xaml.Controls.RadioButton' | 'Windows.UI.Xaml.Controls.InkToolbarToolButton' | 'Windows.UI.Xaml.Controls.InkToolbarPenButton' | 'Windows.UI.Xaml.Controls.InkToolbarBallpointPenButton' | 'Windows.UI.Xaml.Controls.InkToolbarCustomPenButton' | 'Windows.UI.Xaml.Controls.InkToolbarToggleButton' | 'Windows.UI.Xaml.Controls.InkToolbarCustomToggleButton' | 'Windows.UI.Xaml.Controls.InkToolbarCustomToolButton' | 'Windows.UI.Xaml.Controls.InkToolbarEraserButton' | 'Windows.UI.Xaml.Controls.InkToolbarFlyoutItem' | 'Windows.UI.Xaml.Controls.InkToolbarHighlighterButton' | 'Windows.UI.Xaml.Controls.InkToolbarMenuButton' | 'Windows.UI.Xaml.Controls.InkToolbarPencilButton' | 'Windows.UI.Xaml.Controls.InkToolbarRulerButton' | 'Windows.UI.Xaml.Controls.InkToolbarStencilButton' | 'Windows.UI.Xaml.Controls.Primitives.RepeatButton';
    commandParameter?: object;
...
export interface NativeToggleButtonProps extends NativeButtonBaseProps {
    type: 'Windows.UI.Xaml.Controls.Primitives.ToggleButton' | 'Windows.UI.Xaml.Controls.AppBarToggleButton' | 'Windows.UI.Xaml.Controls.CheckBox' | 'Windows.UI.Xaml.Controls.RadioButton' | 'Windows.UI.Xaml.Controls.InkToolbarToolButton' | 'Windows.UI.Xaml.Controls.InkToolbarPenButton' | 'Windows.UI.Xaml.Controls.InkToolbarBallpointPenButton' | 'Windows.UI.Xaml.Controls.InkToolbarCustomPenButton' | 'Windows.UI.Xaml.Controls.InkToolbarToggleButton' | 'Windows.UI.Xaml.Controls.InkToolbarCustomToggleButton' | 'Windows.UI.Xaml.Controls.InkToolbarCustomToolButton' | 'Windows.UI.Xaml.Controls.InkToolbarEraserButton' | 'Windows.UI.Xaml.Controls.InkToolbarHighlighterButton' | 'Windows.UI.Xaml.Controls.InkToolbarMenuButton' | 'Windows.UI.Xaml.Controls.InkToolbarPencilButton' | 'Windows.UI.Xaml.Controls.InkToolbarRulerButton' | 'Windows.UI.Xaml.Controls.InkToolbarStencilButton';
...
export interface NativeItemsControlProps extends NativeControlProps {
    type: 'Windows.UI.Xaml.Controls.ItemsControl' | 'Microsoft.UI.Xaml.Controls.Primitives.TabViewListView' | 'Microsoft.UI.Xaml.Controls.TreeViewList' | 'Windows.UI.Xaml.Controls.AutoSuggestBox' | 'Windows.UI.Xaml.Controls.Primitives.Selector' | 'Windows.UI.Xaml.Controls.ComboBox' | 'Windows.UI.Xaml.Controls.CommandBarOverflowPresenter' | 'Windows.UI.Xaml.Controls.FlipView' | 'Windows.UI.Xaml.Controls.ListViewBase' | 'Windows.UI.Xaml.Controls.GridView' | 'Windows.UI.Xaml.Controls.ListBox' | 'Windows.UI.Xaml.Controls.ListView' | 'Windows.UI.Xaml.Controls.MenuFlyoutPresenter' | 'Windows.UI.Xaml.Controls.NavigationViewList' | 'Windows.UI.Xaml.Controls.Pivot' | 'Windows.UI.Xaml.Controls.TreeViewList';
    itemsSource?: object;
    itemContainerStyle?: string;
...
export interface NativeIconElementProps extends NativeFrameworkElementProps {
    type: 'Windows.UI.Xaml.Controls.IconElement' | 'Microsoft.UI.Xaml.Controls.AnimatedIcon' | 'Microsoft.UI.Xaml.Controls.ImageIcon' | 'Windows.UI.Xaml.Controls.BitmapIcon' | 'Windows.UI.Xaml.Controls.FontIcon' | 'Windows.UI.Xaml.Controls.IconSourceElement' | 'Windows.UI.Xaml.Controls.PathIcon' | 'Windows.UI.Xaml.Controls.SymbolIcon';
    foreground?: ColorValue;
}
...
export interface NativePanelProps extends NativeFrameworkElementProps {
    type: 'Windows.UI.Xaml.Controls.Panel' | 'Microsoft.UI.Xaml.Controls.Primitives.InfoBarPanel' | 'Microsoft.UI.Xaml.Controls.Primitives.MonochromaticOverlayPresenter' | 'Windows.UI.Xaml.Controls.Canvas' | 'Windows.UI.Xaml.Controls.Grid' | 'Windows.UI.Xaml.Controls.ItemsStackPanel' | 'Windows.UI.Xaml.Controls.ItemsWrapGrid' | 'Windows.UI.Xaml.Controls.Primitives.CalendarPanel' | 'Windows.UI.Xaml.Controls.VirtualizingPanel' | 'Windows.UI.Xaml.Controls.Primitives.CarouselPanel' | 'Windows.UI.Xaml.Controls.Primitives.LoopingSelectorPanel' | 'Windows.UI.Xaml.Controls.Primitives.OrientedVirtualizingPanel' | 'Windows.UI.Xaml.Controls.Primitives.PivotHeaderPanel' | 'Windows.UI.Xaml.Controls.Primitives.PivotPanel' | 'Windows.UI.Xaml.Controls.RelativePanel' | 'Windows.UI.Xaml.Controls.StackPanel' | 'Windows.UI.Xaml.Controls.SwapChainBackgroundPanel' | 'Windows.UI.Xaml.Controls.SwapChainPanel' | 'Windows.UI.Xaml.Controls.VariableSizedWrapGrid' | 'Windows.UI.Xaml.Controls.VirtualizingStackPanel' | 'Windows.UI.Xaml.Controls.WrapGrid';
    background?: ColorValue;
}
...
export interface NativeSelectorProps extends NativeItemsControlProps {
    type: 'Windows.UI.Xaml.Controls.Primitives.Selector' | 'Microsoft.UI.Xaml.Controls.Primitives.TabViewListView' | 'Microsoft.UI.Xaml.Controls.TreeViewList' | 'Windows.UI.Xaml.Controls.ComboBox' | 'Windows.UI.Xaml.Controls.FlipView' | 'Windows.UI.Xaml.Controls.ListViewBase' | 'Windows.UI.Xaml.Controls.GridView' | 'Windows.UI.Xaml.Controls.ListBox' | 'Windows.UI.Xaml.Controls.ListView' | 'Windows.UI.Xaml.Controls.NavigationViewList' | 'Windows.UI.Xaml.Controls.TreeViewList';
...
export interface NativeSelectorItemProps extends NativeContentControlProps {
    type: 'Windows.UI.Xaml.Controls.Primitives.SelectorItem' | 'Microsoft.UI.Xaml.Controls.TabViewItem' | 'Microsoft.UI.Xaml.Controls.TreeViewItem' | 'Windows.UI.Xaml.Controls.ComboBoxItem' | 'Windows.UI.Xaml.Controls.FlipViewItem' | 'Windows.UI.Xaml.Controls.GridViewItem' | 'Windows.UI.Xaml.Controls.ListBoxItem' | 'Windows.UI.Xaml.Controls.ListViewItem' | 'Windows.UI.Xaml.Controls.NavigationViewItemBase' | 'Windows.UI.Xaml.Controls.NavigationViewItem' | 'Windows.UI.Xaml.Controls.NavigationViewItemHeader' | 'Windows.UI.Xaml.Controls.NavigationViewItemSeparator' | 'Windows.UI.Xaml.Controls.TreeViewItem';
    isSelected?: boolean;
}
...
export interface NativeFlyoutBaseProps extends NativeDependencyObjectProps {
    type: 'Windows.UI.Xaml.Controls.Primitives.FlyoutBase' | 'Microsoft.UI.Xaml.Controls.CommandBarFlyout' | 'Microsoft.UI.Xaml.Controls.MenuBarItemFlyout' | 'Microsoft.UI.Xaml.Controls.TextCommandBarFlyout' | 'Windows.UI.Xaml.Controls.CommandBarFlyout' | 'Windows.UI.Xaml.Controls.Primitives.PickerFlyoutBase' | 'Windows.UI.Xaml.Controls.DatePickerFlyout' | 'Windows.UI.Xaml.Controls.Flyout' | 'Windows.UI.Xaml.Controls.ListPickerFlyout' | 'Windows.UI.Xaml.Controls.MenuFlyout' | 'Windows.UI.Xaml.Controls.MenuBarItemFlyout' | 'Windows.UI.Xaml.Controls.PickerFlyout' | 'Windows.UI.Xaml.Controls.TextCommandBarFlyout' | 'Windows.UI.Xaml.Controls.TimePickerFlyout';
...
export interface NativeContentDialogProps extends NativeContentControlProps {
    ...
    */
    showState?: Enums.ContentDialogState;
...
export interface NativeContentPresenterProps extends NativeFrameworkElementProps {
    type: 'Windows.UI.Xaml.Controls.ContentPresenter' | 'Microsoft.UI.Xaml.Controls.RevealListViewItemPresenter' | 'Windows.UI.Xaml.Controls.Primitives.GridViewItemPresenter' | 'Windows.UI.Xaml.Controls.Primitives.ListViewItemPresenter' | 'Windows.UI.Xaml.Controls.ScrollContentPresenter';
    foreground?: ColorValue;
    fontWeight?: number;
    fontStyle?: Enums.FontStyle;
    fontStretch?: Enums.FontStretch;
...
export interface NativePickerFlyoutBaseProps extends NativeFlyoutBaseProps {
    type: 'Windows.UI.Xaml.Controls.Primitives.PickerFlyoutBase' | 'Windows.UI.Xaml.Controls.DatePickerFlyout' | 'Windows.UI.Xaml.Controls.ListPickerFlyout' | 'Windows.UI.Xaml.Controls.PickerFlyout' | 'Windows.UI.Xaml.Controls.TimePickerFlyout';
}
...
export interface NativeListViewBaseProps extends NativeSelectorProps {
    type: 'Windows.UI.Xaml.Controls.ListViewBase' | 'Microsoft.UI.Xaml.Controls.Primitives.TabViewListView' | 'Microsoft.UI.Xaml.Controls.TreeViewList' | 'Windows.UI.Xaml.Controls.GridView' | 'Windows.UI.Xaml.Controls.ListView' | 'Windows.UI.Xaml.Controls.NavigationViewList' | 'Windows.UI.Xaml.Controls.TreeViewList';
...
export interface NativeRadioButtonProps extends NativeToggleButtonProps {
    type: 'Windows.UI.Xaml.Controls.RadioButton' | 'Windows.UI.Xaml.Controls.InkToolbarToolButton' | 'Windows.UI.Xaml.Controls.InkToolbarPenButton' | 'Windows.UI.Xaml.Controls.InkToolbarBallpointPenButton' | 'Windows.UI.Xaml.Controls.InkToolbarCustomPenButton' | 'Windows.UI.Xaml.Controls.InkToolbarCustomToolButton' | 'Windows.UI.Xaml.Controls.InkToolbarEraserButton' | 'Windows.UI.Xaml.Controls.InkToolbarHighlighterButton' | 'Windows.UI.Xaml.Controls.InkToolbarPencilButton';
    groupName?: string;
}
export interface NativeInkToolbarToolButtonProps extends NativeRadioButtonProps {
    type: 'Windows.UI.Xaml.Controls.InkToolbarToolButton' | 'Windows.UI.Xaml.Controls.InkToolbarPenButton' | 'Windows.UI.Xaml.Controls.InkToolbarBallpointPenButton' | 'Windows.UI.Xaml.Controls.InkToolbarCustomPenButton' | 'Windows.UI.Xaml.Controls.InkToolbarCustomToolButton' | 'Windows.UI.Xaml.Controls.InkToolbarEraserButton' | 'Windows.UI.Xaml.Controls.InkToolbarHighlighterButton' | 'Windows.UI.Xaml.Controls.InkToolbarPencilButton';
    isExtensionGlyphShown?: boolean;
}
export interface NativeInkToolbarPenButtonProps extends NativeInkToolbarToolButtonProps {
    type: 'Windows.UI.Xaml.Controls.InkToolbarPenButton' | 'Windows.UI.Xaml.Controls.InkToolbarBallpointPenButton' | 'Windows.UI.Xaml.Controls.InkToolbarCustomPenButton' | 'Windows.UI.Xaml.Controls.InkToolbarHighlighterButton' | 'Windows.UI.Xaml.Controls.InkToolbarPencilButton';
...
export interface NativeListViewProps extends NativeListViewBaseProps {
    type: 'Windows.UI.Xaml.Controls.ListView' | 'Microsoft.UI.Xaml.Controls.Primitives.TabViewListView' | 'Microsoft.UI.Xaml.Controls.TreeViewList' | 'Windows.UI.Xaml.Controls.NavigationViewList' | 'Windows.UI.Xaml.Controls.TreeViewList';
}
...
export interface NativeListViewItemProps extends NativeSelectorItemProps {
    type: 'Windows.UI.Xaml.Controls.ListViewItem' | 'Microsoft.UI.Xaml.Controls.TabViewItem' | 'Microsoft.UI.Xaml.Controls.TreeViewItem' | 'Windows.UI.Xaml.Controls.NavigationViewItemBase' | 'Windows.UI.Xaml.Controls.NavigationViewItem' | 'Windows.UI.Xaml.Controls.NavigationViewItemHeader' | 'Windows.UI.Xaml.Controls.NavigationViewItemSeparator' | 'Windows.UI.Xaml.Controls.TreeViewItem';
}
...
export interface NativeMenuFlyoutItemBaseProps extends NativeControlProps {
    type: 'Windows.UI.Xaml.Controls.MenuFlyoutItemBase' | 'Microsoft.UI.Xaml.Controls.RadioMenuFlyoutItem' | 'Windows.UI.Xaml.Controls.MenuFlyoutItem' | 'Windows.UI.Xaml.Controls.MenuFlyoutSeparator' | 'Windows.UI.Xaml.Controls.MenuFlyoutSubItem' | 'Windows.UI.Xaml.Controls.ToggleMenuFlyoutItem';
}
...
export interface NativeVirtualizingPanelProps extends NativePanelProps {
    type: 'Windows.UI.Xaml.Controls.VirtualizingPanel' | 'Windows.UI.Xaml.Controls.Primitives.CarouselPanel' | 'Windows.UI.Xaml.Controls.Primitives.OrientedVirtualizingPanel' | 'Windows.UI.Xaml.Controls.VirtualizingStackPanel' | 'Windows.UI.Xaml.Controls.WrapGrid';
}
...
export interface NativeRangeBaseProps extends NativeControlProps {
    type: 'Windows.UI.Xaml.Controls.Primitives.RangeBase' | 'Microsoft.UI.Xaml.Controls.Primitives.ColorPickerSlider' | 'Microsoft.UI.Xaml.Controls.ProgressBar' | 'Windows.UI.Xaml.Controls.Slider' | 'Windows.UI.Xaml.Controls.Primitives.ColorPickerSlider' | 'Windows.UI.Xaml.Controls.Primitives.ScrollBar' | 'Windows.UI.Xaml.Controls.ProgressBar';
    value?: number;
    smallChange?: number;
    minimum?: number;
    maximum?: number;
...
export interface NativeRichTextBlockProps extends NativeFrameworkElementProps {
    ...
    horizontalTextAlignment?: Enums.TextAlignment;
    typographyAnnotationAlternates?: number;
    typographyCapitalSpacing?: boolean;
    typographyCapitals?: Enums.FontCapitals;
    typographyCaseSensitiveForms?: boolean;
    typographyContextualAlternates?: boolean;
    typographyContextualLigatures?: boolean;
    typographyContextualSwashes?: number;
    typographyDiscretionaryLigatures?: boolean;
    typographyEastAsianExpertForms?: boolean;
    typographyEastAsianLanguage?: Enums.FontEastAsianLanguage;
    typographyEastAsianWidths?: Enums.FontEastAsianWidths;
    typographyFraction?: Enums.FontFraction;
    typographyHistoricalForms?: boolean;
    typographyHistoricalLigatures?: boolean;
    typographyKerning?: boolean;
    typographyMathematicalGreek?: boolean;
    typographyNumeralAlignment?: Enums.FontNumeralAlignment;
    typographyNumeralStyle?: Enums.FontNumeralStyle;
    typographySlashedZero?: boolean;
    typographyStandardLigatures?: boolean;
    typographyStandardSwashes?: number;
    typographyStylisticAlternates?: number;
    typographyStylisticSet10?: boolean;
    typographyStylisticSet11?: boolean;
    typographyStylisticSet12?: boolean;
    typographyStylisticSet13?: boolean;
    typographyStylisticSet14?: boolean;
    typographyStylisticSet15?: boolean;
    typographyStylisticSet16?: boolean;
    typographyStylisticSet17?: boolean;
    typographyStylisticSet18?: boolean;
    typographyStylisticSet19?: boolean;
    typographyStylisticSet1?: boolean;
    typographyStylisticSet20?: boolean;
    typographyStylisticSet2?: boolean;
    typographyStylisticSet3?: boolean;
    typographyStylisticSet4?: boolean;
    typographyStylisticSet5?: boolean;
    typographyStylisticSet6?: boolean;
    typographyStylisticSet7?: boolean;
    typographyStylisticSet8?: boolean;
    typographyStylisticSet9?: boolean;
    typographyVariants?: Enums.FontVariants;
    onContextMenuOpening?: (event: NativeSyntheticEvent<undefined>) => void;
    onSelectionChanged?: (event: NativeSyntheticEvent<undefined>) => void;
...
export interface NativeShapeProps extends NativeFrameworkElementProps {
    type: 'Windows.UI.Xaml.Shapes.Shape' | 'Windows.UI.Xaml.Shapes.Ellipse' | 'Windows.UI.Xaml.Shapes.Line' | 'Windows.UI.Xaml.Shapes.Path' | 'Windows.UI.Xaml.Shapes.Polygon' | 'Windows.UI.Xaml.Shapes.Polyline' | 'Windows.UI.Xaml.Shapes.Rectangle';
...
export type XamlControlProps = NativeWinUI.NativeAnimatedIconProps | NativeWinUI.NativeAnimatedVisualPlayerProps | NativeWinUI.NativeBreadcrumbBarProps | NativeWinUI.NativeBreadcrumbBarItemProps | NativeWinUI.NativeColorPickerProps | NativeWinUI.NativeCommandBarFlyoutProps | NativeWinUI.NativeDropDownButtonProps | NativeWinUI.NativeExpanderProps | NativeWinUI.NativeImageIconProps | NativeWinUI.NativeInfoBadgeProps | NativeWinUI.NativeInfoBarProps | NativeWinUI.NativeItemsRepeaterProps | NativeWinUI.NativeItemsRepeaterScrollHostProps | NativeWinUI.NativeMenuBarProps | NativeWinUI.NativeMenuBarItemProps | NativeWinUI.NativeMenuBarItemFlyoutProps | NativeWinUI.NativeNavigationViewProps | NativeWinUI.NativeNavigationViewItemBaseProps | NativeWinUI.NativeNavigationViewItemProps | NativeWinUI.NativeNavigationViewItemHeaderProps | NativeWinUI.NativeNavigationViewItemSeparatorProps | NativeWinUI.NativeNumberBoxProps | NativeWinUI.NativeParallaxViewProps | NativeWinUI.NativePersonPictureProps | NativeWinUI.NativePipsPagerProps | NativeWinUI.NativeColorPickerSliderProps | NativeWinUI.NativeColorSpectrumProps | NativeWinUI.NativeCommandBarFlyoutCommandBarProps | NativeWinUI.NativeInfoBarPanelProps | NativeWinUI.NativeMonochromaticOverlayPresenterProps | NativeWinUI.NativeNavigationViewItemPresenterProps | NativeWinUI.NativeTabViewListViewProps | NativeWinUI.NativeProgressBarProps | NativeWinUI.NativeProgressRingProps | NativeWinUI.NativeRadioButtonsProps | NativeWinUI.NativeRadioMenuFlyoutItemProps | NativeWinUI.NativeRatingControlProps | NativeWinUI.NativeRefreshContainerProps | NativeWinUI.NativeRefreshVisualizerProps | NativeWinUI.NativeRevealListViewItemPresenterProps | NativeWinUI.NativeSplitButtonProps | NativeWinUI.NativeSwipeControlProps | NativeWinUI.NativeTabViewProps | NativeWinUI.NativeTabViewItemProps | NativeWinUI.NativeTeachingTipProps | NativeWinUI.NativeTextCommandBarFlyoutProps | NativeWinUI.NativeToggleSplitButtonProps | NativeWinUI.NativeTreeViewProps | NativeWinUI.NativeTreeViewItemProps | NativeWinUI.NativeTreeViewListProps | NativeWinUI.NativeTwoPaneViewProps | NativeWinUI.NativeWebView2Props | NativeDependencyObjectProps | NativeUIElementProps | NativeFrameworkElementProps | NativeControlProps | NativeContentControlProps | NativeAppBarProps | NativeButtonBaseProps | NativeButtonProps | NativeAppBarButtonProps | NativeAppBarElementContainerProps | NativeAppBarSeparatorProps | NativeToggleButtonProps | NativeAppBarToggleButtonProps | NativeItemsControlProps | NativeAutoSuggestBoxProps | NativeIconElementProps | NativeBitmapIconProps | NativeBorderProps | NativeCalendarDatePickerProps | NativeCalendarViewProps | NativeCalendarViewDayItemProps | NativePanelProps | NativeCanvasProps | NativeCaptureElementProps | NativeCheckBoxProps | NativeColorPickerProps | NativeSelectorProps | NativeComboBoxProps | NativeSelectorItemProps | NativeComboBoxItemProps | NativeCommandBarProps | NativeFlyoutBaseProps | NativeCommandBarFlyoutProps | NativeCommandBarOverflowPresenterProps | NativeContentDialogProps | NativeContentPresenterProps | NativeDatePickerProps | NativePickerFlyoutBaseProps | NativeDatePickerFlyoutProps | NativeDropDownButtonProps | NativeFlipViewProps | NativeFlipViewItemProps | NativeFlyoutProps | NativeFlyoutPresenterProps | NativeFontIconProps | NativeFrameProps | NativeGridProps | NativeListViewBaseProps | NativeGridViewProps | NativeListViewBaseHeaderItemProps | NativeGridViewHeaderItemProps | NativeGridViewItemProps | NativeGroupItemProps | NativeHandwritingViewProps | NativeHubProps | NativeHubSectionProps | NativeHyperlinkButtonProps | NativeIconSourceElementProps | NativeImageProps | NativeInkCanvasProps | NativeInkToolbarProps | NativeRadioButtonProps | NativeInkToolbarToolButtonProps | NativeInkToolbarPenButtonProps | NativeInkToolbarBallpointPenButtonProps | NativeInkToolbarCustomPenButtonProps | NativeInkToolbarToggleButtonProps | NativeInkToolbarCustomToggleButtonProps | NativeInkToolbarCustomToolButtonProps | NativeInkToolbarEraserButtonProps | NativeInkToolbarFlyoutItemProps | NativeInkToolbarHighlighterButtonProps | NativeInkToolbarMenuButtonProps | NativeInkToolbarPenConfigurationControlProps | NativeInkToolbarPencilButtonProps | NativeInkToolbarRulerButtonProps | NativeInkToolbarStencilButtonProps | NativeItemsPresenterProps | NativeItemsStackPanelProps | NativeItemsWrapGridProps | NativeListBoxProps | NativeListBoxItemProps | NativeListPickerFlyoutProps | NativeListViewProps | NativeListViewHeaderItemProps | NativeListViewItemProps | NativeMapControlProps | NativeMediaElementProps | NativeMediaPlayerElementProps | NativeMediaPlayerPresenterProps | NativeMediaTransportControlsProps | NativeMenuBarProps | NativeMenuBarItemProps | NativeMenuFlyoutProps | NativeMenuBarItemFlyoutProps | NativeMenuFlyoutItemBaseProps | NativeMenuFlyoutItemProps | NativeMenuFlyoutPresenterProps | NativeMenuFlyoutSeparatorProps | NativeMenuFlyoutSubItemProps | NativeNavigationViewProps | NativeNavigationViewItemBaseProps | NativeNavigationViewItemProps | NativeNavigationViewItemHeaderProps | NativeNavigationViewItemSeparatorProps | NativeNavigationViewListProps | NativeUserControlProps | NativePageProps | NativeParallaxViewProps | NativePasswordBoxProps | NativePathIconProps | NativePersonPictureProps | NativePickerFlyoutProps | NativePivotProps | NativePivotItemProps | NativeCalendarPanelProps | NativeVirtualizingPanelProps | NativeCarouselPanelProps | NativeRangeBaseProps | NativeSliderProps | NativeColorPickerSliderProps | NativeColorSpectrumProps | NativeCommandBarFlyoutCommandBarProps | NativeGridViewItemPresenterProps | NativeListViewItemPresenterProps | NativeNavigationViewItemPresenterProps | NativeOrientedVirtualizingPanelProps | NativePivotHeaderItemProps | NativePivotHeaderPanelProps | NativePivotPanelProps | NativePopupProps | NativeRepeatButtonProps | NativeScrollBarProps | NativeThumbProps | NativeTickBarProps | NativeProgressBarProps | NativeProgressRingProps | NativeRatingControlProps | NativeRefreshContainerProps | NativeRefreshVisualizerProps | NativeRelativePanelProps | NativeRichEditBoxProps | NativeRichTextBlockProps | NativeRichTextBlockOverflowProps | NativeScrollContentPresenterProps | NativeScrollViewerProps | NativeSearchBoxProps | NativeSemanticZoomProps | NativeSettingsFlyoutProps | NativeSplitButtonProps | NativeSplitViewProps | NativeStackPanelProps | NativeSwapChainBackgroundPanelProps | NativeSwapChainPanelProps | NativeSwipeControlProps | NativeSymbolIconProps | NativeTextBlockProps | NativeTextBoxProps | NativeTextCommandBarFlyoutProps | NativeTimePickerProps | NativeTimePickerFlyoutProps | NativeToggleMenuFlyoutItemProps | NativeToggleSplitButtonProps | NativeToggleSwitchProps | NativeToolTipProps | NativeTreeViewProps | NativeTreeViewItemProps | NativeTreeViewListProps | NativeTwoPaneViewProps | NativeVariableSizedWrapGridProps | NativeViewboxProps | NativeVirtualizingStackPanelProps | NativeWebViewProps | NativeWrapGridProps | NativeTextElementProps | NativeBlockProps | NativeInlineProps | NativeSpanProps | NativeBoldProps | NativeContentLinkProps | NativeGlyphsProps | NativeHyperlinkProps | NativeInlineUIContainerProps | NativeItalicProps | NativeLineBreakProps | NativeParagraphProps | NativeRunProps | NativeUnderlineProps | NativeKeyboardAcceleratorProps | NativeShapeProps | NativeEllipseProps | NativeLineProps | NativePathProps | NativePolygonProps | NativePolylineProps | NativeRectangleProps;
