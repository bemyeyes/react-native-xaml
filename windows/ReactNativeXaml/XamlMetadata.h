...
SetImageSourceForInlineData(std::string str, xaml::DependencyObject o, xaml::DependencyProperty dp);
...
template <typename T>
bool IsType(const winrt::Windows::Foundation::IInspectable &i) {
  return i.try_as<T>() != nullptr;
}
...
inline void ReadValue(JSValue const &jsValue, xaml::Media::Geometry &value) noexcept {
  ...
  value =
      Markup::XamlBindingHelper::ConvertValue(winrt::xaml_typename<xaml::Media::PathGeometry>(), winrt::box_value(v))
          .as<xaml::Media::Geometry>();
}
...
void SetPropValue(
    ...
    const xaml::DependencyProperty &prop,
  ...
  if constexpr (std::is_same_v<winrt::Windows::UI::Xaml::Controls::Maps::MapStyle, T>) {
    ...
    switch (v.Type()) {
      case JSValueType::String:
        return SetPropValue<winrt::hstring>(o, prop, v, context);
      case JSValueType::Boolean:
        return SetPropValue<bool>(o, prop, v, context);
      case JSValueType::Double:
        return SetPropValue<double>(o, prop, v, context);
      case JSValueType::Int64:
        return SetPropValue<int64_t>(o, prop, v, context);
...
struct PropInfo {
  ...
  using asType_t =
      winrt::Windows::Foundation::IInspectable(__cdecl *)(const winrt::Windows::Foundation::IInspectable &);
  asType_t asType;

  using xamlPropertyGetter_t = xaml::DependencyProperty (*)();
  xamlPropertyGetter_t xamlPropertyGetter;

  using xamlPropertySetter_t = void (*)(
      const xaml::DependencyObject &,
      const xaml::DependencyProperty &,
      const winrt::Microsoft::ReactNative::JSValue &,
  ...
  void SetValue(
      const xaml::DependencyObject &o,
      const winrt::Microsoft::ReactNative::JSValue &v,
      const winrt::Microsoft::ReactNative::IReactContext &context) const {
...
struct XamlMetadata : std::enable_shared_from_this<XamlMetadata> {
  ...
  winrt::Windows::Foundation::IInspectable Create(
  ...
  void PopulateNativeProps(
      winrt::Windows::Foundation::Collections::IMap<winrt::hstring, ViewManagerPropertyType> &nativeProps) const;
  void PopulateNativeEvents(
      winrt::Windows::Foundation::Collections::IMap<winrt::hstring, ViewManagerPropertyType> &nativeProps) const;
  ...
  winrt::Microsoft::ReactNative::IReactDispatcher UIDispatcher() const {
    return m_reactContext.UIDispatcher();
  }
  xaml::DependencyObject ElementFromTag(int64_t tag) const {
    return winrt::Microsoft::ReactNative::XamlUIService::FromContext(m_reactContext).ElementFromReactTag(tag);
  }
 ...
 private:
  ...
  static const PropInfo *FindFirstMatch(
      const stringKey &key,
      const winrt::Windows::Foundation::IInspectable &obj,
      const PropInfo *map,
      size_t size);
