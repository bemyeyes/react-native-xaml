...
xaml::Media::Brush BrushFromColorObject(winrt::hstring resourceName) {
  ...
  if (!brush) {
    try {
      auto color = winrt::unbox_value<winrt::Windows::UI::Color>(xaml::Markup::XamlBindingHelper::ConvertValue(
          winrt::xaml_typename<winrt::Windows::UI::Color>(), winrt::box_value(resourceName)));
